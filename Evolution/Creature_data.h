...
public:
	...
	public:
		...
		Iterator(std::list<std::shared_ptr<Creature>>::const_iterator iter) : Creature_iter(iter) {}

		const std::shared_ptr<Creature>& operator*() const { return *Creature_iter; }
	...
	private:
		std::list<std::shared_ptr<Creature>>::const_iterator Creature_iter;
	};
	...
	void remove_creature(const std::shared_ptr <Creature>&);
	void push_back(std::shared_ptr <Creature>);
private:
	std::list<std::shared_ptr<Creature>> list_;
};
