...
protected:
	...
	std::optional<Creature*> is_herbivirous_near(Creature_data& field);
	virtual std::optional<Creature*> is_enemy_near(Creature_data& field) = 0;
	virtual void move(Creature_data& field, const Coord&);
	virtual void eat(Creature_data& field, Creature&);
	virtual void breed(Creature_data& field);
	virtual void battle(Creature_data& field, Creature& enemy);
